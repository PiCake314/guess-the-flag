...
// const Map<String, String> CODE_TO_COUNTRY = {
//   "AD": "Andorra",
...
typedef Country = (String, String, String, int, double, double);
...
const Country Antigua_and_Barbuda = (
  "Antigua and Barbuda",
  "AG",
  "ATG",
  28,
...
const Country Caribbean_Netherlands = (
...
const Country Bosnia_and_Herzegovina = (
...
const Country British_Indian_Ocean_Territory = (
...
const Country Central_African_Republic = (
...
const Country Christmas_Island = (
  "Christmas Island",
  "CX",
  "CXR",
  162,
...
const Country Cocos_Keeling_Islands = (
...
const Country Dominican_Republic = (
  "Dominican Republic",
  "DO",
  "DOM",
  214,
...
const Country Equatorial_Guinea = (
  "Equatorial Guinea",
  "GQ",
  "GNQ",
  226,
...
const Country French_Southern_Territories = (
...
const Country Lao_Peoples_Democratic_Republic = (
  "Lao",
  "LA",
  "LAO",
  418,
...
const Country Marshall_Islands = (
  "Marshall Islands",
  "MH",
  "MHL",
  584,
...
const Country Northern_Mariana_Islands = (
...
const Country Papua_New_Guinea = (
  "Papua New Guinea",
  "PG",
  "PNG",
  598,
...
const Country Saint_Kitts_and_Nevis = (
...
const Country Sao_Tome_and_Principe = (
...
const Country South_Georgia_and_the_South_Sandwich_Islands = (
...
const Country Syrian_Arab_Republic = (
...
const Country Trinidad_andTobago = (
  "Trinidad and Tobago",
  "TT",
  "TTO",
  780,
...
const Country Turks_and_Caicos_Islands = (
...
const Country United_Arab_Emirates = (
...
const Country Northern_Ireland = (
    "Northern Ireland",
    "GB-NIR",
    "NIR",
    44,
...
const Country Virgin_Islands_British = (
...
const Country Virgin_Islands_US = (
  "Virgin Islands, U.S.",
  "VI",
  "VIR",
  850,
